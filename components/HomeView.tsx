...
type LiveQuote = { total: number; call: number; toWaive: number; breakdown: string[]; categories: Set<TradeKey>; hasWork: boolean };
      ...
      <section id="about" className="py-16 sm:py-20 bg-[#F8FAFC]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-6 text-[#1A1A1A]">
            <span className="text-[#0056B3]">D</span><span className="text-[#FFAB00]">E</span><span className="text-[#424242]">P</span> about us
          </h2>
          <p className="max-w-4xl mx-auto text-center text-[#424242]">DEP Home Repair handles drywall, electrical, and plumbing with one licensed tradesperson on the job. Licensed • Bonded • Insured • ROC 277978</p>
        </div>
      </section>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t) => (
              <div key={`${t.name}-${t.location}`} className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                ...
                <p className="text-[#424242] mb-5">&ldquo;{t.text}&rdquo;</p>
